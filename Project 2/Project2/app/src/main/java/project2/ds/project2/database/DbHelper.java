...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void populateDatabase() {
        ...
        //TODO: add more animals to the database just like below.
        ...
        addAnimal(koala);
        Animal bunny = new Animal(129000, 65, "Human", "USA", "Froyo, lettuce, Acai Berries", "Beautiful, friendly, and from a small town, Likes to bounce around, and hop on things. Easily distracted by shiny objects.", R.drawable.bunny, "Rosemary");
        addAnimal(bunny);
        ...
        addAnimal(blobFish);
        Animal rock = new Animal(1500000, 130, "Fish", "New Zealand", "Anything fat-free", "Official Mascot of the UAPS (Ugly Animal Preservation Society) Excellent deep-sea diver. Big-boned.", R.drawable.petrock, "Anjellica");
        addAnimal(rock);
