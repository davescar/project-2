...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void populateDatabase() {
        ...
        addAnimal(blobFish);
        Animal rock = new Animal(3, 15000000, "Sedimentary", "New York", "Vegan", "Social, hard-headed, likes company. This rock will never let you down, and offers great protection against giants.", R.drawable.pet_rock2, "Eric");
        addAnimal(rock);
        Animal AyeAye = new Animal(900, 21, "Aye-Aye", "Madagascar", "Grubs, fruit, sap, chicken wings", "Finger model. Third-eye (lid). Once thought to be extinct, Aye-Ayes are here to stay.", R.drawable.ayeaye, "Dikembe Mutombo");
        addAnimal(AyeAye);
        ...
        Animal Naked_Mole_Rat = new Animal(6000, 31, "Naked Mole Rat", "East Africa", "Tubers, corn on the cob", " Neither moles nor rats, Naked Mole Rats are not totally hairless. Say what! The Mole Rat species in one of the two Mammalia that is eusocial.", R.drawable.nakedmolerat, "Teef");
